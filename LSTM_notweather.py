...
dl.Data_load_notweather("Animal", sensor, DataX, DataY)
dl.Data_load_notweather("Human", sensor, DataX, DataY)
dl.Data_load_notweather("Both", sensor, DataX, DataY)
dl.Data_load_notweather("None", sensor, DataX, DataY)
...
model.compile(optimizer=tf.train.AdadeltaOptimizer(learning_rate=0.001),
